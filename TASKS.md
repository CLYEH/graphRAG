...
- [ ] BA3b inspection: entities/relations — list+get × entities/relations (+`Relation.evidence[]` on detail), same binding seam/cursor pattern; keysets likely (created_at,id) with the NULLS-ordering care from #40
