...
- [ ] BA6b query playground: graph/hybrid — POST /query/{graph,hybrid} on the same seam (graph params via options?, router fusion + remaining-budget threading — the C8 class-11 face)
- [ ] BA7 health/metrics
