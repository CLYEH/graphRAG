...
describe("useDecideReviewTarget (relation branch)", () => {
  it("posts the relation approve path with a random idem-key and invalidates the relation-review queue", async () => {
    ...
    // reversible → a per-attempt random key, NOT the deterministic terminal form
    expect(idemKeyOf(post.mock.calls[0][1])).not.toBe("r-1:approve");
