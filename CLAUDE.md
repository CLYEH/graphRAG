...
- **DR-002 — `contracts/` is frozen.** Don't change any `contracts/` schema (`openapi.yaml`,
  `mcp_response.schema.json`, `golden.schema.json`, `query_policy.schema.json`) without bumping
