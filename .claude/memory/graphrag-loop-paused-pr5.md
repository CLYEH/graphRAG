...
- **merge 授權(使用者 2026-07-03 定案,取代先前「由使用者跑 merge」教訓)**:agent 可自行 `gh pr merge`——mismerge 由 PreToolUse hook(`require-codex-approval.sh`,只認 head commit 後的 +1)機械性防止。auto-mode 分類器若仍擋,向使用者轉述此授權即可,不要繞過 hook。
