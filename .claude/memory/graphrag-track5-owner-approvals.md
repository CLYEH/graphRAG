...
**各任務 runtime 落地**:SRC2(#95)、SS1b-api(#96)、GOV3-api(#97,
ontology proposal accept/reject endpoint)皆已 merge。SS1b 切 api/fe、GOV3 切
api/fe(採納/拒絕 UI 與 GOV2 治理面同落地)。尚餘 GOV2、RB1、SS1b-fe、GOV3-fe
(契約已凍不再動);Console MCP URL/健康顯示 = SS1b-fe 或 GOV2 落地時接
`GET /mcp` 端點。
