...
**各任務 runtime 落地**:SRC2 已 merge(PR #95);SS1b-api 已 merge(PR #96,
entities/documents server-side `q`+totals;SS1b 因跨 backend/FE/perf 切
SS1b-api/SS1b-fe,fe 待做);尚餘 GOV2/GOV3/RB1 + SS1b-fe(契約已凍不再動);
Console MCP URL/健康顯示 = SS1b 或
GOV2 落地時接 `GET /mcp` 端點。
