...
- [BA3 進度](graphrag-ba3-prep.md) — BA3a 已 merge(PR #55);剩 BA3b(entities/relations,status=REQUIRED 先查欄位 nullability)/BA3c(subgraph=Neo4j 面);可沿用 _bind/fetch_page/cursor/harness
