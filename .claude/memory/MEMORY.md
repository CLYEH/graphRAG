...
- [Loop 流程教訓](graphrag-loop-paused-pr5.md) — watcher 監聽 reviews+reactions+comments 三管道;merge 由使用者跑;Codex P2/P3 意見先判讀(必要才修,非必要給可查核理由後 resolve);同類問題一次掃完壓輪次;PR/任務即時狀態一律查 TASKS.md/GitHub,不查本檔
