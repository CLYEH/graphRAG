...
- [UX 翻新兩急件](graphrag-ux-redesign.md) — owner 2026-07-14 核准開工:Track 4(UXA1-3/UXB1/UXC1-2)已入 TASKS.md;Phase A 純FE/B 設定頁/C=契約 v1.2(eval+upload,DR-002 bump 已核准,§26 隨 UXC1 落地);提案=.discuss/ux-redesign/PROPOSAL.md;UXA1✅#76(12輪16P2→class 20)UXA2✅#77(3輪→class 21:mock對齊真實信封;先枚舉狀態機奏效)
