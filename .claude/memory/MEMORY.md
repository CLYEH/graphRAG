...
- [BA3 進度](graphrag-ba3-prep.md) — BA3a/#55、BA3b/#56 已 merge;剩 BA3c(subgraph=Neo4j session seam、hops 受 query_policy cap、#31/#33 read/emit 覆驗面);可沿用 _bind/fetch_page/cursor/harness
