...
- [BA2e 開工前研究](graphrag-ba2e-prep.md) — triggers/jobs/SSE 凍結合約形狀摘要;切片提議 BA2e-1(triggers+get/cancel)/BA2e-2(SSE);設計約束:create_job→enqueue crash 窗(class-12 sibling)、SSE 讀 SoR 不讀 arq(keep_result=0)
